...
public enum ErrorCode {
    ...
    REQUEST_BODY_MISSING_ERROR(400, "요청값이 비어있습니다."),

    // 유효하지 않은 타입
    INVALID_TYPE_VALUE(400, "올바르지 않은 요청값입니다."),

    // Request Parameter로 데이터가 전달되지 않을 경우
    ...
    // @RequestBody 및 @ReqeustParam, @PathVariable이 유효하지 않음
    NOT_VALID_ERROR(404, "handel Validation Exception"),

    // Header에 데이터가 존재하지 않는 경우
    NOT_VALID_HEADER_ERROR(404, "Missing Header Data"),

    // 서버가 처리할 방법을 모르는 경우 발생
    INTERNAL_SERVER_ERROR(500, "Internal Server Error Exception"),

    /**
     * ********************* Custom Error CodeList ******************************
     */
    CUSTOM_EXCEPTION_ERROR(200, "Custion Exception Error"),

    // 삽입 에러
    INSER_ERROR(200, "Insert Transaction Error Exception"),
